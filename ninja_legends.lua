-- ============================================================
--  Laysox Hub - Ninja Legends
--  Discord : https://discord.gg/tFkAe2RVKB
--  UI Base : Inori / Ririchi | Script original : flanut
-- ============================================================
--[[
...
-- Pets2 window
local Pets2 = library:CreateWindow("Pet Stuff 2")
Pets2:Section("- Vendre Pets Speciaux -")
Pets2:Toggle("Sell Winter Wonder Kitty",   {flag = "S1"})
Pets2:Toggle("Sell Winter Legends Polar",  {flag = "S2"})
Pets2:Toggle("Sell Christmas Sensei",      {flag = "S3"})
Pets2:Toggle("Sell Dark Blizzard Penguin", {flag = "S4"})
Pets2:Toggle("Sell Cybernetic Sleigh",     {flag = "S5"})
...
Credits:Section("- Laysox Hub -")
Credits:Label("laysox")
Credits:Label("UI Base: Inori / Ririchi")
Credits:Label("Script original: flanut")
Credits:Label("Discord: discord.gg/tFkAe2RVKB")
