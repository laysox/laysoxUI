...
MStr.Color = C.border; MStr.Thickness = 1
...
TB.InputBegan:Connect(function(i)
    if i.UserInputType == Enum.UserInputType.MouseButton1 then
        drag=true; ds=i.Position; dp=MF.Position
    end
end)
...
CloseB.MouseButton1Click:Connect(function()
    setVisible(false); MF.Visible = false
end)
...
local function CB(parent,lbl,default,x,y,w,cb)
    ...
    f.Size = UDim2.new(0,w,0,20); f.Position = UDim2.new(0,x,0,y)
    ...
    label.TextSize = 11; label.Font = Enum.Font.Gotham
    label.TextXAlignment = Enum.TextXAlignment.Left
    local val = default
    local btn = Instance.new("TextButton",f)
    btn.Size = UDim2.new(1,0,1,0); btn.BackgroundTransparency = 1; btn.Text = ""
    local function sv(v)
        val=v; box.BackgroundColor3=v and C.acc or C.bg3; tick.Text=v and "✓" or ""
    end
...
local function SL(parent,lbl,min,max,default,x,y,w,cb)
    local f = Instance.new("Frame",parent)
    f.Size = UDim2.new(0,w,0,34); f.Position = UDim2.new(0,x,0,y)
    f.BackgroundTransparency = 1
    local top = Instance.new("Frame",f)
    top.Size = UDim2.new(1,0,0,14); top.BackgroundTransparency = 1
    local ll = Instance.new("TextLabel",top)
    ll.Size = UDim2.new(0.6,0,1,0); ll.BackgroundTransparency = 1
    ll.Text = lbl; ll.TextColor3 = C.txt; ll.TextSize = 10
    ll.Font = Enum.Font.Gotham; ll.TextXAlignment = Enum.TextXAlignment.Left
    local vl = Instance.new("TextLabel",top)
    vl.Size = UDim2.new(0.4,0,1,0); vl.Position = UDim2.new(0.6,0,0,0)
    vl.BackgroundTransparency = 1; vl.Text = tostring(default).."/"..tostring(max)
    vl.TextColor3 = C.txt2; vl.TextSize = 10
    vl.Font = Enum.Font.Gotham; vl.TextXAlignment = Enum.TextXAlignment.Right
    local track = Instance.new("Frame",f)
    track.Size = UDim2.new(1,0,0,5); track.Position = UDim2.new(0,0,0,17)
    ...
    local function upd(mx)
        ...
        vl.Text = tostring(val).."/"..tostring(max)
...
local function KB(parent,lbl,default,x,y,w,cb)
    ...
    ll.Size = UDim2.new(0.55,0,1,0); ll.BackgroundTransparency = 1
    ll.Text = lbl; ll.TextColor3 = C.txt; ll.TextSize = 10
    ll.Font = Enum.Font.Gotham; ll.TextXAlignment = Enum.TextXAlignment.Left
...
local function DD(parent,lbl,opts,default,x,y,w,cb)
    ...
    f.BackgroundTransparency = 1
    local ll = Instance.new("TextLabel",f)
    ll.Size = UDim2.new(0.45,0,1,0); ll.BackgroundTransparency = 1
    ll.Text = lbl; ll.TextColor3 = C.txt; ll.TextSize = 10
    ll.Font = Enum.Font.Gotham; ll.TextXAlignment = Enum.TextXAlignment.Left
    ...
    db.MouseButton1Click:Connect(function()
        ...
        for i,opt in ipairs(opts) do
            ...
            ob.MouseEnter:Connect(function()
                ob.BackgroundTransparency=0; ob.BackgroundColor3=C.bg3
            end)
...
DD(visualsP,"Direction",{"Clockwise","Counterclockwise"},"Clockwise",RX,vry,RW,function(v)
    Cfg.SpinDir=v=="Clockwise" and 1 or -1
end);                                                                                      vry=vry+24
...
CB(miscP,"Infinite Jump",false,8,mly,LW,function(v)
    Cfg.IJ=v; if v then startIJ() else stopIJ() end
end);                                                                                      mly=mly+22
...
CB(miscP,"WalkSpeed",false,8,mly,LW,function(v)
    Cfg.WS=v; if v then startWS() else stopWS() end
end);                                                                                      mly=mly+22
...
CB(miscP,"JumpPower",false,8,mly,LW,function(v)
    Cfg.JP=v; if v then startJP() else stopJP() end
end);                                                                                      mly=mly+22
...
cb1.BackgroundColor3=C.red; cb1.Text="FERMER LSX V1"
cb1.TextColor3=Color3.new(1,1,1); cb1.TextSize=11
cb1.Font=Enum.Font.GothamBold; cb1.BorderSizePixel=0
...
cb1.MouseButton1Click:Connect(function()
    ...
    print=_print; warn=_warn; GUI:Destroy()
end)

local cb2 = Instance.new("TextButton",settP)
cb2.Size=UDim2.new(0,LW,0,24); cb2.Position=UDim2.new(0,8,0,sly+30)
cb2.BackgroundColor3=Color3.fromRGB(60,20,20); cb2.Text="RAGE QUIT"
cb2.TextColor3=Color3.new(1,1,1); cb2.TextSize=11
cb2.Font=Enum.Font.GothamBold; cb2.BorderSizePixel=0
...
-- ========================
-- FEATURES — chargées APRES le GUI (evite freeze)
-- ========================
task.spawn(function()
    -- Attend que le perso soit pret sans bloquer
    local timeout = 0
    while not lp.Character and timeout < 30 do
    ...
    local function startFly()
        ...
        local gyro = Instance.new("BodyGyro"); gyro.Name="FlyG"
        gyro.MaxTorque=Vector3.new(1,1,1)*math.huge; gyro.P=100000
        gyro.CFrame=h.CFrame; gyro.Parent=h
        local vel = Instance.new("BodyVelocity"); vel.Name="FlyV"
